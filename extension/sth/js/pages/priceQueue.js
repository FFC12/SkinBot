...
var PriceQueue = {
  ...
  PricesProviders: [
    {
      ...
      getprice: function (appid, countryCode, currencyId, market_hash_name) {
        ...
        var url = 'https://steamcommunity.com/market/priceoverview/?appid=' + appid + '&country=' + countryCode + '&currency=' + currencyId + '&market_hash_name=' + market_hash_name;
    ...
    },
    {
      ...
      getprice: function (appid, countryCode, currencyId, market_hash_name) {
        var cacheURL = 'appid=' + appid + '&country=' + countryCode + '&currency=' + currencyId + '&market_hash_name=' + market_hash_name;
        var url = 'https://steamcommunity.com/market/listings/' + appid + '/' + market_hash_name + '/render/?start=0&count=5&country=' + countryCode + '&language=english&currency=' + currencyId;
  ...
  GenPriceDescription: function (rgItems) {
    ...
    var marketLink = "https://steamcommunity.com/market/listings/" + rgItems.appid + "/" + encodeURIComponent(rgItems.market_hash_name);
